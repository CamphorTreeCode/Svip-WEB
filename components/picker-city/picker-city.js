    ...
    let addrss = []
     ...
     //     this.render([8, 0, 13])
          ...
          console.log("444",this)
            ...
            console.log(value, addrss,"lengtg", value.toString() == addrss, value.toString() == [8, 0, 13].toString() )
         
            if (value.toString() == addrss){
              console.log("突出方法", addrss)
              addrss = value
              console.log("11", addrss)
                typeof options.hides === `function` && options.hides()
              

            
              
            }else {
              console.log("执行了functions")
